...
import { EmailIcon, WhatsAppIcon, TelegramIcon, ViberIcon, PhoneIcon } from '../common/Icons';
    ...
    <footer className="bg-gray-900 text-white">
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <div>
                <div className="font-bold text-lg">Red Sea Valley</div>
                <div className="text-sm text-gray-400">Premium Real Estate</div>
              </div>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Your trusted partner for luxury properties in Hurghada, Sahl Hasheesh, El Gouna, and Soma Bay.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/regions" className="text-gray-400 hover:text-primary-400 transition-colors">
                  Regions
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 text-sm">
          <p>&copy; {new Date().getFullYear()} Red Sea Valley Real Estate. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
